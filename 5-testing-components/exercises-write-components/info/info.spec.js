...
describe('info: renders some info under a caption', () => {
  describe('several colors, no id', () => {
    ...
    describe(`.children[0]`, () => {
      ...
      it('has innerText: "several colors"', () => {
        expect(actualChild.innerText).toEqual('several colors');
      });
    ...
    describe(`.children[1]`, () => {
      ...
      it('has innerText: "red, orange, green, blue."', () => {
        expect(actualChild.innerText).toEqual('red, orange, green, blue.');
      });
      it('has childElementCount: 0', () => {
        expect(actualChild.childElementCount).toEqual(0);
      });
  ...
  describe('what is javascript?, id "js"', () => {
    ...
    describe(`.children[0]`, () => {
      ...
      it('has innerText: "what is javascript?"', () => {
        expect(actualChild.innerText).toEqual('what is javascript?');
      });
      it('has childElementCount: 0', () => {
        expect(actualChild.childElementCount).toEqual(0);
      });
    ...
    describe(`.children[1]`, () => {
      ...
      it('has innerText: "a programming language!"', () => {
        expect(actualChild.innerText).toEqual('a programming language!');
      });
      it('has childElementCount: 0', () => {
        expect(actualChild.childElementCount).toEqual(0);
      });
